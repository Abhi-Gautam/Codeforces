...
int main()
{
    ...
    test
    {
        ...
        bool ans = false;
        if(s.substr(0, 4) == "2020" || s.substr(n-4, 4) == "2020") ans = true;
        else if(s[0] == '2' && s.substr(n-3, 3) == "020") ans = true;
        else if(s.substr(0, 2) == "20" && s.substr(n-2, 2) == "20") ans = true;
        else if(s.substr(0, 3) == "202" && s[n-1] == '0') ans = true;
